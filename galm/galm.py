...
def geolm_minimize(f, x0, jac=None, lup=5., ldo=10., fargs=(), fkwargs={}, jargs=(),
                jkwargs={}, keep_steps=False, j0=None, r0=None, geo=True, l0=100,
    ...
    keep_steps - Boolean for keeping intermediary steps (default False)
    j0, r0 - initial residual and jacobian values (default is to recompute).
    geo - Boolean for whether to use geodesic acceleration (default True)
